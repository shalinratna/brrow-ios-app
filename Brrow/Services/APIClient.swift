...
class APIClient: ObservableObject {
    ...
    func fetchEarningsOverview() async throws -> EarningsOverview {
        ...
        return EarningsOverview(
            ...
            payoutTier: response.data.payoutInfo.payoutTier,
            payoutTierCode: response.data.payoutInfo.payoutTierCode,
            holdDays: response.data.payoutInfo.holdDays,
            emailVerified: response.data.payoutInfo.emailVerified,
            idVerified: response.data.payoutInfo.idVerified,
            tierCompletedSales: response.data.payoutInfo.completedSales,
            nextPayoutDate: response.data.payoutInfo.nextPayoutDate,
